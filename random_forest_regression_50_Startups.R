...
setwd("D:\\Manoela\\Dropbox\\Aulas\\Data Mining\\Aula 11 - 12 - Regressão")
...
#treino
targetForecast = data.frame(training_set$Profit, y_treino)
ggplot(targetForecast, aes(y_treino, training_set.Profit)) + geom_point() +
